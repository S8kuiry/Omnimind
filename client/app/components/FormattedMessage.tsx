...
import { normalizeMarkdown, normalizeDocumentMarkdown } from '@/lib/markdownNormalize'
...
export default function FormattedMessage({
  ...
  const normalized = useMemo(() => {
    if (documentMode) {
      return normalizeDocumentMarkdown(content)
    }
    return normalizeMarkdown(content, { forStream: isStreaming })
  }, [content, isStreaming, documentMode])
